...
//  TestSCNView
//
//  Created by Zhang xiaosong on 2018/4/12.
...
class PlaneBox: SCNNode {
    ...
    init(withAnchor anchor: ARPlaneAnchor, isHidden hidden:Bool) {
        ...
        planeGeometry = SCNBox(width: CGFloat(width), height: CGFloat(planeHeight), length: CGFloat(lenght), chamferRadius: 0)
